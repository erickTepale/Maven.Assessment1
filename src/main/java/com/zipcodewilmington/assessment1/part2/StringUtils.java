...
public class StringUtils {
     ...
     */
    public static String[] getWords(String sentence) { return sentence.split(" "); }
     ...
     */
    public static String getFirstWord(String sentence) { return getWords(sentence)[0]; }
    ...
    public static String removeCharacterAtIndex(String str, int index) {
        String[] lettrs = str.split("");
        ArrayList<String> newLettrs = new ArrayList<>();

        for (int i = 0; i <lettrs.length ; i++) {
            if(! (i == index) )
                newLettrs.add(lettrs[i]);
        }

        return String.valueOf(String.join("", newLettrs));
    }
